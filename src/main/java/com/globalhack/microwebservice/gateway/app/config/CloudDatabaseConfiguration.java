package com.globalhack.microwebservice.gateway.app.config;
...
@Configuration
@EnableMongoRepositories("com.globalhack.microwebservice.gateway.app.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.globalhack.microwebservice.gateway.app.config.dbmigrations");
